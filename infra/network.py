...
class Network:
    ...
    def __init__(self, config) -> None:
        ...
        self.elastic_ip = self._create_elastic_ip()
    ...
    def _create_elastic_ip(self, eip_name='elastic-ip'):
        return ec2.Eip(
            f'{self.config.project_name}-{eip_name}',
            tags={
                'Name': f'{self.config.project_name}-{eip_name}'
            }
        )
